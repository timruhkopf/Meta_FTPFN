"""
This Script is the original FT-PFN meta_batch function, but adapted to the new structure.
"""
...
from ppfn.prior import DimensionPrior, FidelityPrior
...
if __name__ == "__main__":
    ...
    # create plot with multiple curves based on the meta_batch
    batch = get_batch(
        batch_size=4,
        seq_len=32,
        num_features=5,
